...
- 유튜브 탭
    - 사용자의 선호 아티스트 정보를 반영하여 youtube 원본 영상을 보여줍니다.
    - 무한 스크롤이 적용됩니다.
...
### 검색하기
- 검색어를 입력하여 연관된 Pop, youtube 원본 동영상, User를 찾을 수 있습니다.
...
<br>
- 다중 피드
    - User가 원하는 아티스트, 멤버 별 피드를 생성할 수 있습니다.
    - 각각의 피드 별로 별도의 Pop을 추가 및 삭제할 수 있습니다.
