...
public class UserEntity {
	 ...
	 * // 단방향과 달리 추가된 부분
	 * 
	 * @OneToMany(mappedBy = "team") // Team.members는 연관관계의 주인이 아님, Member.team은
	 * 연관관계의 주인임 private List<Member> members = new ArrayList<>();
	 * 
	 */
	 ...
	 * @ManyToOne
	 * 
	 * @JoinColumn(name ="team_id") // FK private Team team; *
	 */
