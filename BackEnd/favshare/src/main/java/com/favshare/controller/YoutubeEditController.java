...
public class YoutubeEditController {
	...
	@PostMapping("/info")
	public ResponseEntity<YoutubeInfoDto> showYoutubeEdit(@RequestBody HashMap<String, String> editInfo) {
		try {
			YoutubeInfoDto youtubeEditDto = youtubeService.getEditInfoById(editInfo);
